    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 md:space-y-8 md:px-6 md:py-8 lg:px-8">
        <header className="space-y-4 text-center md:space-y-5">
          ...
          <h1 className="mx-auto max-w-6xl bg-gradient-to-r from-cyan-200 via-blue-100 to-purple-200 bg-clip-text text-3xl font-bold leading-tight text-transparent md:text-5xl">
            {t("h1")}
          </h1>
