...
import HoursToDecimalCalculatorConverter from "./components/HoursToDecimalCalculatorConverter"

export default async function HoursToDecimalCalculatorPage() {
  const t = await getTranslations("HoursToDecimalCalculator")
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 md:space-y-8 md:px-6 md:py-8 lg:px-8">
        ...
        <HoursToDecimalCalculatorConverter />
