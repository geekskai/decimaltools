...
import MillimetersToDecimalConverter from "./components/MillimetersToDecimalConverter"

export default async function MillimetersToDecimalPage() {
  const t = await getTranslations("MillimetersToDecimal")
