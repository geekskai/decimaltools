              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    className="h-10 w-full rounded-xl border border-cyan-500/30 bg-slate-950/80 px-3 text-sm text-white focus:border-cyan-400 focus:outline-none focus:ring-4 focus:ring-cyan-500/20"
                  >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-2xl border border-white/10 bg-slate-950/50 p-4">
                    ...
                    <p className="mt-1.5 text-base text-slate-100 md:text-lg">{result.value.fractionLabel}</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-slate-950/50 p-4">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-400 md:text-xs md:tracking-[0.16em]">
                      {t("offset_output_label")}
                    </p>
                    <p className="mt-1.5 text-base text-slate-100 md:text-lg">{result.value.offsetLabel} in</p>
                  </div>
                </div>

                {result.value.showLargeDimensionHint ? (
                  <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-xs text-amber-100 md:text-sm">
