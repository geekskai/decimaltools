        ...
        <div className="grid gap-4 md:grid-cols-2 md:items-stretch">
          <div className="rounded-2xl border border-cyan-500/20 bg-slate-950/45 p-3.5 md:p-5">
            <div className="flex h-full flex-col gap-4">
              ...
              <div>
                <p className="mb-2.5 text-sm font-semibold text-slate-200 md:mb-3">
                  {t("examples_title")}
                </p>
            ...
            <div className="flex items-center justify-between gap-3 pb-2">
              ...
              <div className="flex flex-col items-stretch gap-2 md:flex-row md:items-center md:gap-3">
                <button
                  type="button"
                  onClick={handleCopy}
                  className="w-full rounded-xl bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 px-3 py-1 md:px-3 md:py-2 text-sm font-bold text-white shadow-xl shadow-emerald-500/25 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/30 md:w-auto"
                >
                  {t("copy")}
                </button>
                {copyMessage ? (
                  <span className="text-xs text-slate-300 md:text-sm">{copyMessage}</span>
                ) : null}
              <button
                type="button"
                onClick={handleClear}
